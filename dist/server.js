...
function buildPayload(chartType, series, title, fallbackPoints = []) {
    ...
    const payload = { chartType, series: resolvedSeries };
...
export function createServer() {
    ...
    registerAppTool(server, "draw-line-chart", {
        ...
        const payload = buildPayload("line", sanitizedSeries, sanitizedTitle, sanitizedPoints);
        return {
            content: [
                {
                    type: "text",
